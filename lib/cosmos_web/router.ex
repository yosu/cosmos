defmodule CosmosWeb.Router do
  ...
  import CosmosWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {CosmosWeb.Layouts, :root}
  ...
  if Application.compile_env(:cosmos, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: CosmosWeb.Telemetry
  ...
  scope "/", CosmosWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{CosmosWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", CosmosWeb do
    ...
    live_session :current_user,
      on_mount: [{CosmosWeb.UserAuth, :mount_current_user}] do
