defmodule CosmosWeb.UserAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_cosmos_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      CosmosWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule CosmosWeb.PageLive do
        use CosmosWeb, :live_view

        on_mount {CosmosWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{CosmosWeb.UserAuth, :ensure_authenticated}] do
  ...
  defp signed_in_path(_conn), do: ~p"/journals"
end
